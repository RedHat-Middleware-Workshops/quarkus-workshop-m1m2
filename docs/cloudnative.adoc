...
----
mvn -q quarkus:add-extension -Dextensions="smallrye-health" -f $CHE_PROJECTS_ROOT/quarkus-workshop-labs
----
...
[source,sh,role=copypaste]
----
mvn -q quarkus:generate-config -f $CHE_PROJECTS_ROOT/quarkus-workshop-labs
----
