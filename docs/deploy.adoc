...
Select on the circle to get details:

image::container1.png[container,700]

Select on the **View Logs** link to see the console output from the app:
...
Go back to the _Topology_ view. Since this app is exposed to the world, a _Route_ was created which you can access using the small arrow in the upper right of the circle. Select on the route link:
