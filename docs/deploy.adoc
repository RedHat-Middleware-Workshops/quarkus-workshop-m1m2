...
[NOTE]
====
You may see _Container people does not have health checks to ensure your application is running correctly_. Don't worry and we will add MicroProfile health check at the next step.
====
