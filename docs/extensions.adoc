...
To get started, {{ DS_URL }}#https://github.com/RedHat-Middleware-Workshops/quarkus-workshop-m1m2-labs/tree/rhbq-3.27[access the Red Hat OpenShift Dev Spaces instance^] and select *Log in with OpenShift* button:
