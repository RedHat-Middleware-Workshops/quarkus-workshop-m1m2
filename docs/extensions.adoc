...
[source,sh,role="copypaste"]
----
cd $CHE_PROJECTS_ROOT/quarkus-workshop-labs && git checkout ocp-4.6
----
...
[source,none]
----
2020-10-23 14:27:00,102 INFO  [io.quarkus] (Quarkus Main Thread) people 1.0-SNAPSHOT on JVM (powered by Quarkus x.x.x) started in 0.972s. Listening on: http://0.0.0.0:8080
2020-10-23 14:27:00,102 INFO  [io.quarkus] (Quarkus Main Thread) Profile dev activated. Live Coding activated.
2020-10-23 14:27:00,103 INFO  [io.quarkus] (Quarkus Main Thread) Installed features: [cdi, resteasy]
----
