...
image::yellow-squigglies.png[yellow, 300]

This is due to not yet installing any database extensions. That's part of the _Advanced_ labs which you may or may not be doing today, so you can ignore them for now!
...
[source, none]
----
INFO  [io.quarkus] (main) Quarkus xx.xx.xx on JVM started in 1.286s. Listening on: http://localhost:8083
----
