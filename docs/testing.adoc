...
As you see, `All tests passed` on the right bottom. When you select `Open` on the left bottom, it will show the Quarkus runtime logs:
...
Select `Test results` then it will show the details of the test results:
