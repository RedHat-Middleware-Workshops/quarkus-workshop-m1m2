...
----
2020-05-17 22:53:05,792 INFO  [io.quarkus] (main) Quarkus xx.xx.xx started in 0.015s. Listening on: http://0.0.0.0:8081
----
...
----
    PID   RSS COMMAND
   1066 49160 /projects/quarkus-workshop-labs/target/people-1.0-SNAPSHOT-runner -Dquarkus.http.port=8081
----

This shows that our process is taking around 50 MB of memory (https://en.wikipedia.org/wiki/Resident_set_size[Resident Set Size^], or RSS). Pretty compact!
