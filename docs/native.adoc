...
Create a native executable by using the **che: 04. Build Native App** task:
...
ELF Header:
  ...
  Version:                           0x1
  Entry point address:               0x4051f0
  Start of program headers:          64 (bytes into file)
  Start of section headers:          41322472 (bytes into file)
  Flags:                             0x0
...
[source,sh,role="copypaste"]
----
target/people-1.0-SNAPSHOT-runner -Dquarkus.http.port=8081 # <1>
----
...
----
INFO  [io.quarkus] (main) people 1.0-SNAPSHOT native (powered by Quarkus 2.13.7.Final-redhat-00003) started in 0.023s. Listening on: http://0.0.0.0:8081
----

That's *23* milliseconds to start up.
...
----
    PID   RSS COMMAND
   8222 41288 target/people-1.0-SNAPSHOT-runner -Dquarkus.http.port=8081
----

This shows that our process is taking around 41 MB of memory (https://en.wikipedia.org/wiki/Resident_set_size[Resident Set Size^], or RSS). Pretty compact!
