...
9328bdfea370  docker.io/postgres:17              24 seconds ago  Healthy (Up)              9328bdfea370dfcd21d574bd4496878a1a02193b127776eb470e75e745e165d8
----
...
Our production environment needs a "real" database so let's deploy a Postgres database to OpenShift. Back in the {{ CONSOLE_URL }}/topology/ns/{{ USER_ID }}-project[Topology View^], select **Software Catalog**, under **Ecosystem** on the left.
