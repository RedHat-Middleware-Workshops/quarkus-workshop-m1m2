...
Click the _Save_ icon at the top to save our new dashboard:
...
* The different quantiles of time it takes to process names `application:org_acme_people_stream_name_converter_converter_seconds` (configure it stack its values on the _Visualization_ tab, and name it "Converter Performance" on the _General_ tab).
...
Your final Dashboard should look like:
