...
* The different quantiles of time it takes to process names `application_org_acme_people_stream_NameConverter_converter_seconds` (Toggle _Stack_ on the _Display_ , and name it `Converter Performance` on the _Panel Title_).
