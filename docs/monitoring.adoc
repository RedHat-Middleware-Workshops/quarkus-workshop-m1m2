...
Follow the same process as before: On the {{ CONSOLE_URL }}/topology/ns/{{ USER_ID }}-project[Topology View, window=blank], click on `+Add`, and choose "Container Image", and fill in the fields:
